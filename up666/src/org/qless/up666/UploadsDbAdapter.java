 ...
 * for the 666kb uploads, and gives the ability to list all uploads as well as
 * retrieve or modify a specific upload.
 * 
...
public class UploadsDbAdapter {
    ...
    private static final String DATABASE_CREATE =
        "create table uploads (_id integer primary key autoincrement, "
    ...
    /**
     * Open the uploads database. If it cannot be opened, try to create a new
    ...
    /**
     * Create a new upload entry using the data provided. If the upload is
     * successfully created return the new rowId for that instance, otherwise return
     ...
     * 
     * @param rowId id of upload to delete
    ...
    public Cursor fetchAllUploads() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {
        		KEY_ROWID, KEY_URL, KEY_FILENAME, KEY_THUMBNAIL, KEY_UPLOAD_DATE, KEY_COMMENT
     ...
     * 
     * @param rowId id of upload to retrieve
     * @return Cursor positioned to matching upload, if found
     * @throws SQLException if upload could not be found/retrieved
     */
    ...
    /**
     * Update the upload using the details provided. The upload to be updated is
     * specified using the rowId, and it is altered to use the comment
     * values passed in
     * 
     * @param rowId id of upload to update
     * @param comment value to set upload comment to
